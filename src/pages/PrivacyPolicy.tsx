      ...
      <main className="flex-grow container mx-auto px-4 py-8">
        <div className="max-w-3xl mx-auto">
          ...
          <div className="bg-white shadow-md rounded-lg p-6 mb-8">
            <h2 className="text-xl font-semibold mb-4">Introduction
...
Company (referred to as either "the Company", "We", "Us" or "Our" in this Agreement) refers to thryvance, 26862.
...
Website refers to thryvance, accessible from https://www.thryvance.ca/
...
By email: thryvance.ca@gmail.com</h2>
